;;; smart-tabs-mode-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
This is a minor mode.  If called interactively, toggle the `Smart-Tabs
...
evaluate the variable `smart-tabs-mode'.
...
(fn LANG MODE-HOOK ADVICE-LIST &rest BODY)" nil t)
(register-definition-prefixes "smart-tabs-mode" '("smart-tabs-"))

;;; End of scraped data
