;;; moe-light-theme.el --- An eye-candy theme for Emacser  -*- lexical-binding: t -*- no-byte-compile: t;
...
(let ((class '((class color) (min-colors 89)))
      ...
      (cyan-1 "#87ffff") (cyan-2 "#87d7af") (cyan-3 "#00d7af") (cyan-4 "#00ac8a") (cyan-5 "#18b2b2") (cyan-6 "#005f5f") (cyan-7 "#236f73")
      (cyan-8 "#00af87") (cyan-9 "#005f87")
      ...
      (black-2 "#8a8a8a") (black-3 "#767676") (black-4 "#626262") (black-5 "#5f5f5f") (black-6 "#3a3a3a") (black-7 "#1a1a1a")
  ...
  (defconst -moe-light-fg                        black-7)
  (defconst -moe-light-builtin                   purple-2)
  (defconst -moe-light-comment-delimiter         black-2)
  (defconst -moe-light-comment                   black-2)
  (defconst -moe-light-constant                  blue-2)
  (defconst -moe-light-doc                       cyan-6)
  (defconst -moe-light-doc-string                yellow-3)
  (defconst -moe-light-function-name             red-1)
  (defconst -moe-light-keyword                   cyan-6)
  (defconst -moe-light-negation-char             red-2)
  (defconst -moe-light-preprocessor              purple-3)
  (defconst -moe-light-regexp-grouping-backslash orange-3)
  (defconst -moe-light-regexp-grouping-construct purple-3)
  (defconst -moe-light-string                    magenta-3)
  (defconst -moe-light-type                      cyan-6)
  (defconst -moe-light-variable-name             orange-4)
  ...
  (custom-theme-set-faces
   'moe-light
   ;; Font-lock faces
   `(font-lock-builtin-face              ((,class (:background unspecified :foreground ,blue-4                  ))))
   `(font-lock-comment-delimiter-face    ((,class (:background unspecified :foreground ,red-2        :slant italic))))
   `(font-lock-comment-face              ((,class (:background unspecified :foreground ,red-2                 :slant italic))))
   `(font-lock-constant-face             ((,class (:background unspecified :foreground ,blue-2                 ))))
   `(font-lock-doc-face                  ((,class (:background unspecified :foreground ,cyan-6                      ))))
   `(font-lock-doc-string-face           ((,class (:background unspecified :foreground ,yellow-3               ))))
   `(font-lock-function-name-face        ((,class (:background unspecified :foreground ,blue-4           ))))
   `(font-lock-keyword-face              ((,class (:background unspecified :foreground ,blue-5                 ))))
   `(font-lock-negation-char-face        ((,class (:background unspecified :foreground ,orange-2            ))))
   `(font-lock-preprocessor-face         ((,class (:background unspecified :foreground ,blue-3             ))))
   `(font-lock-regexp-grouping-backslash ((,class (:background unspecified :foreground ,green-02           ))))
   `(font-lock-regexp-grouping-construct ((,class (:background unspecified :foreground ,purple-3           ))))
   `(font-lock-string-face               ((,class (:background unspecified :foreground ,magenta-3                   ))))
   `(font-lock-type-face                 ((,class (:background unspecified :foreground ,blue-4                     ))))
   `(font-lock-variable-name-face        ((,class (:background unspecified :foreground ,black-7            ))))
   `(font-lock-warning-face              ((,class (:background unspecified :foreground ,orange-2               :weight bold))))
   ...
   ;; Highlighting faces
   `(fringe ((,class (:inherit default :foreground ,black-1))))
   `(line-number ((,class (:inherit default :foreground ,linum-dark :background ,LIGHT_BG))))
   `(line-number-current-line ((,class (:inherit default :background ,linum-dark :foreground ,white-1))))
   `(linum ((,class (:inherit default :foreground ,linum-dark :background ,LIGHT_BG))))
   `(linum-highlight-face ((,class (:inherit default :background ,linum-dark :foreground ,white-1))))
   `(highlight ((,class (:background ,green-0))))
   `(hl-line ((,class (:background ,white-1)))) ; Embedded strings of IM (e.g. fcitx) would be very unreadable... orz
   ...
   `(show-paren-mismatch ((,class (:foreground ,white-0 :background ,red-3 :bold t))))
   `(header-line ((,class (:background ,moe-light-bg :foreground ,blue-3))))
   ...
   `(mode-line ((,class (:box nil :background ,orange-00 :foreground ,black-7))))
   `(mode-line-inactive ((,class (:box nil :background ,white-2 :foreground ,black-2))))
   `(mode-line-buffer-id ((,class (:box nil :foreground ,blue-4 :bold t))))
   ...
   `(minibuffer-prompt ((,class (:foreground ,orange-4 :background nil :bold nil))))
   ...
   `(completions-common-part ((,class (:foreground ,blue-4))))
   ...
   `(dired-mark ((,class (:background ,green-1 :foreground ,black-7))))
   `(dired-marked ((,class (:background ,green-2 :foreground ,black-7))))
   ...
   ;; diff-hl
   `(diff-hl-change ((,class (:foreground ,yellow-3 :background ,yellow-2 :bold t))))
   ...
   ;; avy-mode
   `(avy-lead-face ((,class (:background ,purple-00 :foreground ,purple-4))))
   ...
   `(rainbow-delimiters-depth-2-face ((,class (:bold nil :foreground ,blue-2))))
   `(rainbow-delimiters-depth-3-face ((,class (:bold nil :foreground ,green-3))))
   ...
   `(rainbow-delimiters-depth-8-face ((,class (:bold nil :foreground ,yellow-3))))
   `(rainbow-delimiters-depth-9-face ((,class (:bold nil :foreground ,black-5))))
  ...
  `(flycheck-warnline ((,class (:foreground ,orange-3 :bold t))))
  `(flycheck-error-list-info ((,class (:foreground ,orange-3 :bold t))))
