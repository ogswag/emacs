;;; moe-dark-theme.el --- An eye-candy theme for Emacser  -*- lexical-binding: t -*- no-byte-compile: t;
...
(let ((class '((class color) (min-colors 89)))
  ...
  (defconst -moe-dark-comment-delimiter          black-1)
  (defconst -moe-dark-comment                    black-1)
  ...
  (defconst -moe-dark-keyword                    cyan-4)
  ...
  (defconst -moe-dark-variable-name              orange-1)
  ...
  (custom-theme-set-faces
   ...
   `(line-number ((,class (:inherit default :foreground ,white-3 :background ,black-3))))
   `(linum-highlight-face ((,class (:background ,black-2-5 :foreground ,yellow-00))))
   `(line-number-current-line ((,class (:inherit default :background ,black-2-5 :foreground ,yellow-00))))
   `(highlight ((,class (:background ,black-3))))
   `(hl-line ((,class (:background ,black-4))))
   `(highlight-symbol-face ((,class (:background ,green-5))))
   `(region ((,class (:foreground ,white-2 :background ,black-2-5))))
   ...
   `(show-paren-mismatch ((,class (:foreground ,white-0 :background ,red-2 :bold t))))
   ...
   `(mode-line-buffer-id ((,class (:box nil :foreground ,green-2 :background unspecified :bold t))))
   ...
   `(completions-common-part ((,class (:foreground ,blue-1))))
   ...
   `(org-block ((,class (:foreground ,white-1 :background ,black-4))))
   `(org-block-background ((,class (:foreground unspecified :background ,black-4))))
   `(org-block-begin-line ((,class (:foreground ,white-0 :background ,blue-3 :extend nil))))
   `(org-block-end-line ((,class (:foreground ,white-3 :background ,black-3 :extend nil))))
   ...
   ;; Rainbow-delimiters
   `(rainbow-delimiters-depth-1-face ((,class (:bold t :foreground ,red-0))))
   ...
   `(rainbow-delimiters-unmatched-face ((,class (:foreground ,white-0 :background ,red-2 :bold t))))
