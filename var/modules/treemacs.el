...
;;
(use-package treemacs-tab-bar :ensure t  ; treemacs-tab-bar if you use tab-bar-mode
  :after (treemacs)
...
(use-package treemacs-nerd-icons
  ...
  :init
  (with-eval-after-load (if (locate-library "lsp-treemacs") 'lsp-treemacs 'treemacs)
